...
pub const EXT_CUSTOM_BORDER_COLOR_SPEC_VERSION: usize = 69;
pub const EXT_CUSTOM_BORDER_COLOR_EXTENSION_NAME: &'static core::ffi::CStr = c"VK_EXT_custom_border_color";
