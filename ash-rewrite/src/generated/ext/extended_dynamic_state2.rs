...
pub const EXT_EXTENDED_DYNAMIC_STATE_2_SPEC_VERSION: usize = 69;
pub const EXT_EXTENDED_DYNAMIC_STATE_2_EXTENSION_NAME: &'static core::ffi::CStr = c"VK_EXT_extended_dynamic_state2";
