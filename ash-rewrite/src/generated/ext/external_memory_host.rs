...
pub const EXT_EXTERNAL_MEMORY_HOST_SPEC_VERSION: usize = 69;
pub const EXT_EXTERNAL_MEMORY_HOST_EXTENSION_NAME: &'static core::ffi::CStr = c"VK_EXT_external_memory_host";
