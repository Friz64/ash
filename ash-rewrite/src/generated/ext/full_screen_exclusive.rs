...
pub const EXT_FULL_SCREEN_EXCLUSIVE_SPEC_VERSION: usize = 69;
pub const EXT_FULL_SCREEN_EXCLUSIVE_EXTENSION_NAME: &'static core::ffi::CStr = c"VK_EXT_full_screen_exclusive";
