...
pub const EXT_IMAGE_COMPRESSION_CONTROL_SWAPCHAIN_SPEC_VERSION: usize = 69;
pub const EXT_IMAGE_COMPRESSION_CONTROL_SWAPCHAIN_EXTENSION_NAME: &'static core::ffi::CStr = c"VK_EXT_image_compression_control_swapchain";
