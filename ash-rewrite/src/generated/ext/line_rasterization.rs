...
pub const EXT_LINE_RASTERIZATION_SPEC_VERSION: usize = 69;
pub const EXT_LINE_RASTERIZATION_EXTENSION_NAME: &'static core::ffi::CStr = c"VK_EXT_line_rasterization";
