...
pub const EXT_MEMORY_DECOMPRESSION_SPEC_VERSION: usize = 69;
pub const EXT_MEMORY_DECOMPRESSION_EXTENSION_NAME: &'static core::ffi::CStr = c"VK_EXT_memory_decompression";
