...
///Provided by [VK_EXT_multisampled_render_to_swapchain](crate::ext::multisampled_render_to_swapchain)
...
pub(crate) mod items {
    ...
    impl<'a> PhysicalDeviceMultisampledRenderToSwapchainFeaturesEXT<'a> {
        pub fn multisampled_render_to_swapchain(
            ...
            self.multisampled_render_to_swapchain = multisampled_render_to_swapchain
                .into();
            self
        }
    }
