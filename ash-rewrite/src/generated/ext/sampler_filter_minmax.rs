...
//![Vulkan Manual Page](https://docs.vulkan.org/refpages/latest/refpages/source/VK_EXT_sampler_filter_minmax.html) · Vulkan extension
...
pub const EXT_SAMPLER_FILTER_MINMAX_SPEC_VERSION: usize = 2;
