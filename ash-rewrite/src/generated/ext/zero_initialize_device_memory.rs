...
pub const EXT_ZERO_INITIALIZE_DEVICE_MEMORY_SPEC_VERSION: usize = 69;
pub const EXT_ZERO_INITIALIZE_DEVICE_MEMORY_EXTENSION_NAME: &'static core::ffi::CStr = c"VK_EXT_zero_initialize_device_memory";
