...
pub const KHR_COPY_MEMORY_INDIRECT_SPEC_VERSION: usize = 69;
pub const KHR_COPY_MEMORY_INDIRECT_EXTENSION_NAME: &'static core::ffi::CStr = c"VK_KHR_copy_memory_indirect";
