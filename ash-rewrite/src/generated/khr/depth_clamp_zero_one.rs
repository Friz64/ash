...
pub const KHR_DEPTH_CLAMP_ZERO_ONE_SPEC_VERSION: usize = 69;
pub const KHR_DEPTH_CLAMP_ZERO_ONE_EXTENSION_NAME: &'static core::ffi::CStr = c"VK_KHR_depth_clamp_zero_one";
