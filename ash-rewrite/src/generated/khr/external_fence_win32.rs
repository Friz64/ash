...
pub const KHR_EXTERNAL_FENCE_WIN32_SPEC_VERSION: usize = 69;
pub const KHR_EXTERNAL_FENCE_WIN32_EXTENSION_NAME: &'static core::ffi::CStr = c"VK_KHR_external_fence_win32";
