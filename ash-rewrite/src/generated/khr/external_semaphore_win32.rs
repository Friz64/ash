...
pub const KHR_EXTERNAL_SEMAPHORE_WIN32_SPEC_VERSION: usize = 69;
pub const KHR_EXTERNAL_SEMAPHORE_WIN32_EXTENSION_NAME: &'static core::ffi::CStr = c"VK_KHR_external_semaphore_win32";
