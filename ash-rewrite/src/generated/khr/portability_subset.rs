...
pub const KHR_PORTABILITY_SUBSET_SPEC_VERSION: usize = 69;
pub const KHR_PORTABILITY_SUBSET_EXTENSION_NAME: &'static core::ffi::CStr = c"VK_KHR_portability_subset";
