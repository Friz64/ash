...
///Provided by [VK_KHR_video_encode_quantization_map](crate::khr::video_encode_quantization_map)
...
pub const NAME: &core::ffi::CStr = c"VK_KHR_video_encode_quantization_map";
pub(crate) mod items {
    #[repr(C)]
