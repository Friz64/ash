...
pub const KHR_VIDEO_ENCODE_QUEUE_SPEC_VERSION: usize = 69;
pub const KHR_VIDEO_ENCODE_QUEUE_EXTENSION_NAME: &'static core::ffi::CStr = c"VK_KHR_video_encode_queue";
