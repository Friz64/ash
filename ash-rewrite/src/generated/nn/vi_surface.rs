...
///Provided by [VK_NN_vi_surface](crate::nn::vi_surface)
...
impl Instance {
    ...
    pub unsafe fn create_vi_surface_nn(
        ...
        (self.fp.create_vi_surface_nn)(instance, p_create_info, p_allocator, p_surface)
    }
}
...
pub(crate) mod items {
    ...
    #[cfg(feature = "debug")]
    impl core::fmt::Debug for ViSurfaceCreateFlagsNN {
