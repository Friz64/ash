...
pub const NV_COMMAND_BUFFER_INHERITANCE_SPEC_VERSION: usize = 69;
pub const NV_COMMAND_BUFFER_INHERITANCE_EXTENSION_NAME: &'static core::ffi::CStr = c"VK_NV_command_buffer_inheritance";
