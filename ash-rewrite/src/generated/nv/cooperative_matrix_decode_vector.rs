...
///Provided by [VK_NV_cooperative_matrix_decode_vector](crate::nv::cooperative_matrix_decode_vector)
...
pub(crate) mod items {
    ...
    impl<'a> PhysicalDeviceCooperativeMatrixDecodeVectorFeaturesNV<'a> {
        pub fn cooperative_matrix_decode_vector(
            ...
            self.cooperative_matrix_decode_vector = cooperative_matrix_decode_vector
                .into();
            self
        }
    }
