...
pub const NV_COVERAGE_REDUCTION_MODE_SPEC_VERSION: usize = 69;
pub const NV_COVERAGE_REDUCTION_MODE_EXTENSION_NAME: &'static core::ffi::CStr = c"VK_NV_coverage_reduction_mode";
