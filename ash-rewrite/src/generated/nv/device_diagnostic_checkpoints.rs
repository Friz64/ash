...
pub const NV_DEVICE_DIAGNOSTIC_CHECKPOINTS_SPEC_VERSION: usize = 69;
pub const NV_DEVICE_DIAGNOSTIC_CHECKPOINTS_EXTENSION_NAME: &'static core::ffi::CStr = c"VK_NV_device_diagnostic_checkpoints";
