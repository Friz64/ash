...
pub const NV_EXTENDED_SPARSE_ADDRESS_SPACE_SPEC_VERSION: usize = 69;
pub const NV_EXTENDED_SPARSE_ADDRESS_SPACE_EXTENSION_NAME: &'static core::ffi::CStr = c"VK_NV_extended_sparse_address_space";
