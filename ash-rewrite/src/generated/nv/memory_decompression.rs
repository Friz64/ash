...
pub const NV_MEMORY_DECOMPRESSION_SPEC_VERSION: usize = 69;
pub const NV_MEMORY_DECOMPRESSION_EXTENSION_NAME: &'static core::ffi::CStr = c"VK_NV_memory_decompression";
