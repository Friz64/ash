...
pub const NV_RAY_TRACING_MOTION_BLUR_SPEC_VERSION: usize = 69;
pub const NV_RAY_TRACING_MOTION_BLUR_EXTENSION_NAME: &'static core::ffi::CStr = c"VK_NV_ray_tracing_motion_blur";
