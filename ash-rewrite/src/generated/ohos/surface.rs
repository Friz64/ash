...
///Provided by [VK_OHOS_surface](crate::ohos::surface)
...
impl Instance {
    ...
    pub unsafe fn create_surface_ohos(
        ...
        (self.fp.create_surface_ohos)(instance, p_create_info, p_allocator, p_surface)
    }
}
...
pub(crate) mod items {
    ...
    #[cfg(feature = "debug")]
    impl core::fmt::Debug for SurfaceCreateFlagsOHOS {
