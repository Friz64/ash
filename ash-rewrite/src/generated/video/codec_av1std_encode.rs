...
- `initial_display_delay_present_for_this_op` @ `2..3`*/
        ...
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            f.debug_struct("EncodeAV1OperatingPointInfoFlags")
                ...
                .field(
                    ...
                    &self.get_initial_display_delay_present_for_this_op(),
                )
                .finish()
        }
    }
    ...
    impl EncodeAV1OperatingPointInfo {
        pub fn flags(
            mut self,
            flags: crate::vk::EncodeAV1OperatingPointInfoFlags,
        ) -> Self {
            self.flags = flags;
            self
        }
...
- `showable_frame` @ `28..29`*/
    ...
    impl EncodeAV1PictureInfoFlags {
        ...
        pub fn frame_size_override_flag(
            mut self,
        ...
        pub fn is_motion_mode_switchable(
            mut self,
        ...
        pub fn disable_frame_end_update_cdf(
            ...
            self.bitfield0 = ((disable_frame_end_update_cdf << 14u32) & 0x00004000)
                | rest;
            self
        }
        ...
        pub fn segmentation_temporal_update(
            ...
            self.bitfield0 = ((segmentation_temporal_update << 23u32) & 0x00800000)
                | rest;
            self
        }
        ...
        pub fn get_uses_chroma_lr(&self) -> u32 {
    ...
    impl<'a> EncodeAV1PictureInfo<'a> {
        ...
        pub fn quantization(
            mut self,
            quantization: &'a crate::vk::AV1Quantization,
        ) -> Self {
        ...
        pub fn segmentation(
            mut self,
            segmentation: &'a crate::vk::AV1Segmentation,
        ) -> Self {
