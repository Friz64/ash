...
#![doc(alias = "vulkan_video_codec_h265std")]
...
- `general_frame_only_constraint_flag` @ `4..5`*/
    ...
    impl H265ProfileTierLevelFlags {
        ...
        pub fn general_progressive_source_flag(
            ...
            self.bitfield0 = ((general_progressive_source_flag << 1u32) & 0x00000002)
                | rest;
            self
        }
        ...
        pub fn general_interlaced_source_flag(
            ...
            self.bitfield0 = ((general_interlaced_source_flag << 2u32) & 0x00000004)
                | rest;
            self
        }
...
- `low_delay_hrd_flag` @ `20..28`*/
    ...
    impl H265HrdFlags {
        ...
        pub fn vcl_hrd_parameters_present_flag(
            ...
            let rest = self.bitfield0 & 0xFFFFFFFD;
            self.bitfield0 = ((vcl_hrd_parameters_present_flag << 1u32) & 0x00000002)
                | rest;
            self
        }
        ...
        pub fn sub_pic_hrd_params_present_flag(
            ...
            let rest = self.bitfield0 & 0xFFFFFFFB;
            self.bitfield0 = ((sub_pic_hrd_params_present_flag << 2u32) & 0x00000004)
                | rest;
            self
        }
        ...
        pub fn get_fixed_pic_rate_general_flag(&self) -> u32 {
            (self.bitfield0 & 0x00000FF0) >> 4u32
        }
        pub fn fixed_pic_rate_within_cvs_flag(
            ...
            self.bitfield0 = ((fixed_pic_rate_within_cvs_flag << 12u32) & 0x000FF000)
                | rest;
            self
        }
        pub fn get_fixed_pic_rate_within_cvs_flag(&self) -> u32 {
            (self.bitfield0 & 0x000FF000) >> 12u32
        }
        ...
        pub fn get_low_delay_hrd_flag(&self) -> u32 {
            (self.bitfield0 & 0x0FF00000) >> 20u32
        }
    }
    #[repr(C)]
    #[derive(Clone, Copy)]
...
- `vps_poc_proportional_to_timing_flag` @ `3..4`*/
    ...
    impl H265VpsFlags {
        ...
        pub fn vps_timing_info_present_flag(
            ...
            let rest = self.bitfield0 & 0xFFFFFFFB;
            self.bitfield0 = ((vps_timing_info_present_flag << 2u32) & 0x00000004)
                | rest;
            self
        }
    ...
    impl<'a> H265VideoParameterSet<'a> {
        ...
        pub fn vps_video_parameter_set_id(
            mut self,
        ...
        pub fn vps_max_sub_layers_minus1(
            mut self,
...
- `delta_rps_sign` @ `1..2`*/
    ...
    impl H265ShortTermRefPicSet {
        ...
        pub fn used_by_curr_pic_s0_flag(
            mut self,
        ...
        pub fn used_by_curr_pic_s1_flag(
            mut self,
...
- `restricted_ref_pic_lists_flag` @ `17..18`*/
    ...
    impl H265SpsVuiFlags {
        ...
        pub fn colour_description_present_flag(
            ...
            self.bitfield0 = ((colour_description_present_flag << 5u32) & 0x00000020)
                | rest;
            self
        }
        ...
        pub fn neutral_chroma_indication_flag(
            ...
            self.bitfield0 = ((neutral_chroma_indication_flag << 7u32) & 0x00000080)
                | rest;
            self
        }
        ...
        pub fn frame_field_info_present_flag(
            ...
            self.bitfield0 = ((frame_field_info_present_flag << 9u32) & 0x00000200)
                | rest;
            self
        }
        ...
        pub fn default_display_window_flag(
            ...
            self.bitfield0 = ((default_display_window_flag << 10u32) & 0x00000400)
                | rest;
            self
        }
        ...
        pub fn vui_timing_info_present_flag(
            ...
            self.bitfield0 = ((vui_timing_info_present_flag << 11u32) & 0x00000800)
                | rest;
            self
        }
        ...
        pub fn vui_poc_proportional_to_timing_flag(
            ...
            self.bitfield0 = ((vui_poc_proportional_to_timing_flag << 12u32)
                & 0x00001000) | rest;
            self
        }
        ...
        pub fn restricted_ref_pic_lists_flag(
            ...
            self.bitfield0 = ((restricted_ref_pic_lists_flag << 17u32) & 0x00020000)
                | rest;
            self
        }
    ...
    impl<'a> H265SequenceParameterSetVui<'a> {
        ...
        pub fn def_disp_win_left_offset(
            mut self,
        ...
        pub fn def_disp_win_right_offset(
            mut self,
        ...
        pub fn max_bits_per_min_cu_denom(
            mut self,
...
- `intra_boundary_filtering_disabled_flag` @ `29..30`*/
    ...
    impl H265SpsFlags {
        ...
        pub fn scaling_list_enabled_flag(
            mut self,
        ...
        pub fn pcm_loop_filter_disabled_flag(
            ...
            let rest = self.bitfield0 & 0xFFFFFDFF;
            self.bitfield0 = ((pcm_loop_filter_disabled_flag << 9u32) & 0x00000200)
                | rest;
            self
        }
        ...
        pub fn sps_temporal_mvp_enabled_flag(
            ...
            let rest = self.bitfield0 & 0xFFFFF7FF;
            self.bitfield0 = ((sps_temporal_mvp_enabled_flag << 11u32) & 0x00000800)
                | rest;
            self
        }
        ...
        pub fn strong_intra_smoothing_enabled_flag(
            ...
            let rest = self.bitfield0 & 0xFFFFEFFF;
            self.bitfield0 = ((strong_intra_smoothing_enabled_flag << 12u32)
                & 0x00001000) | rest;
            self
        }
        ...
        pub fn vui_parameters_present_flag(
            ...
            let rest = self.bitfield0 & 0xFFFFDFFF;
            self.bitfield0 = ((vui_parameters_present_flag << 13u32) & 0x00002000)
                | rest;
            self
        }
        ...
        pub fn sps_range_extension_flag(
            mut self,
        ...
        pub fn transform_skip_rotation_enabled_flag(
            ...
            let rest = self.bitfield0 & 0xFFFEFFFF;
            self.bitfield0 = ((transform_skip_rotation_enabled_flag << 16u32)
                & 0x00010000) | rest;
            self
        }
        ...
        pub fn transform_skip_context_enabled_flag(
            ...
            let rest = self.bitfield0 & 0xFFFDFFFF;
            self.bitfield0 = ((transform_skip_context_enabled_flag << 17u32)
                & 0x00020000) | rest;
            self
        }
        ...
        pub fn implicit_rdpcm_enabled_flag(
            ...
            self.bitfield0 = ((implicit_rdpcm_enabled_flag << 18u32) & 0x00040000)
                | rest;
            self
        }
        ...
        pub fn explicit_rdpcm_enabled_flag(
            ...
            self.bitfield0 = ((explicit_rdpcm_enabled_flag << 19u32) & 0x00080000)
                | rest;
            self
        }
        pub fn get_explicit_rdpcm_enabled_flag(&self) -> u32 {
            (self.bitfield0 & 0x00080000) >> 19u32
        }
        ...
        pub fn get_extended_precision_processing_flag(&self) -> u32 {
            (self.bitfield0 & 0x00100000) >> 20u32
        }
        pub fn intra_smoothing_disabled_flag(
            ...
            self.bitfield0 = ((intra_smoothing_disabled_flag << 21u32) & 0x00200000)
                | rest;
            self
        }
        pub fn get_intra_smoothing_disabled_flag(&self) -> u32 {
            (self.bitfield0 & 0x00200000) >> 21u32
        }
        pub fn high_precision_offsets_enabled_flag(
            ...
            self.bitfield0 = ((high_precision_offsets_enabled_flag << 22u32)
                & 0x00400000) | rest;
            self
        }
        pub fn get_high_precision_offsets_enabled_flag(&self) -> u32 {
            (self.bitfield0 & 0x00400000) >> 22u32
        }
        ...
        pub fn get_persistent_rice_adaptation_enabled_flag(&self) -> u32 {
            (self.bitfield0 & 0x00800000) >> 23u32
        }
        pub fn cabac_bypass_alignment_enabled_flag(
            ...
            self.bitfield0 = ((cabac_bypass_alignment_enabled_flag << 24u32)
                & 0x01000000) | rest;
            self
        }
        pub fn get_cabac_bypass_alignment_enabled_flag(&self) -> u32 {
            (self.bitfield0 & 0x01000000) >> 24u32
        }
        ...
        pub fn get_sps_scc_extension_flag(&self) -> u32 {
            (self.bitfield0 & 0x02000000) >> 25u32
        }
        pub fn sps_curr_pic_ref_enabled_flag(
            ...
            self.bitfield0 = ((sps_curr_pic_ref_enabled_flag << 26u32) & 0x04000000)
                | rest;
            self
        }
        pub fn get_sps_curr_pic_ref_enabled_flag(&self) -> u32 {
            (self.bitfield0 & 0x04000000) >> 26u32
        }
        pub fn palette_mode_enabled_flag(
            mut self,
        ...
        pub fn get_palette_mode_enabled_flag(&self) -> u32 {
            (self.bitfield0 & 0x08000000) >> 27u32
        }
        ...
        pub fn get_sps_palette_predictor_initializers_present_flag(&self) -> u32 {
            (self.bitfield0 & 0x10000000) >> 28u32
        }
        pub fn intra_boundary_filtering_disabled_flag(
            ...
            self.bitfield0 = ((intra_boundary_filtering_disabled_flag << 29u32)
                & 0x20000000) | rest;
            self
        }
        pub fn get_intra_boundary_filtering_disabled_flag(&self) -> u32 {
            (self.bitfield0 & 0x20000000) >> 29u32
        }
    }
    #[repr(C)]
    #[derive(Clone, Copy, Default, Debug)]
    ...
    impl<'a> H265SequenceParameterSet<'a> {
        ...
        pub fn pic_width_in_luma_samples(
            mut self,
        ...
        pub fn sps_video_parameter_set_id(
            mut self,
        ...
        pub fn sps_max_sub_layers_minus1(
            mut self,
        ...
        pub fn num_long_term_ref_pics_sps(
            mut self,
...
- `pps_range_extension_flag` @ `30..31`*/
    ...
    impl H265PpsFlags {
        ...
        pub fn output_flag_present_flag(
            mut self,
        ...
        pub fn sign_data_hiding_enabled_flag(
            ...
            let rest = self.bitfield0 & 0xFFFFFFFB;
            self.bitfield0 = ((sign_data_hiding_enabled_flag << 2u32) & 0x00000004)
                | rest;
            self
        }
        ...
        pub fn cu_qp_delta_enabled_flag(
            mut self,
        ...
        pub fn transquant_bypass_enabled_flag(
            ...
            let rest = self.bitfield0 & 0xFFFFFBFF;
            self.bitfield0 = ((transquant_bypass_enabled_flag << 10u32) & 0x00000400)
                | rest;
            self
        }
        ...
        pub fn loop_filter_across_tiles_enabled_flag(
            ...
            let rest = self.bitfield0 & 0xFFFFBFFF;
            self.bitfield0 = ((loop_filter_across_tiles_enabled_flag << 14u32)
                & 0x00004000) | rest;
            self
        }
        ...
        pub fn deblocking_filter_control_present_flag(
            ...
            let rest = self.bitfield0 & 0xFFFEFFFF;
            self.bitfield0 = ((deblocking_filter_control_present_flag << 16u32)
                & 0x00010000) | rest;
            self
        }
        ...
        pub fn pps_deblocking_filter_disabled_flag(
            ...
            let rest = self.bitfield0 & 0xFFFBFFFF;
            self.bitfield0 = ((pps_deblocking_filter_disabled_flag << 18u32)
                & 0x00040000) | rest;
            self
        }
        ...
        pub fn pps_curr_pic_ref_enabled_flag(
            ...
            let rest = self.bitfield0 & 0xFDFFFFFF;
            self.bitfield0 = ((pps_curr_pic_ref_enabled_flag << 25u32) & 0x02000000)
                | rest;
            self
        }
        ...
        pub fn pps_slice_act_qp_offsets_present_flag(
            ...
            let rest = self.bitfield0 & 0xF7FFFFFF;
            self.bitfield0 = ((pps_slice_act_qp_offsets_present_flag << 27u32)
                & 0x08000000) | rest;
            self
        }
        ...
        pub fn pps_range_extension_flag(
            mut self,
        ...
        pub fn get_pps_range_extension_flag(&self) -> u32 {
            (self.bitfield0 & 0x40000000) >> 30u32
        }
    }
    #[repr(C)]
    #[derive(Clone, Copy)]
    ...
    impl<'a> H265PictureParameterSet<'a> {
        ...
        pub fn log2_sao_offset_scale_luma(
            mut self,
        ...
        pub fn pps_act_y_qp_offset_plus5(
            mut self,
        ...
        pub fn pps_act_cb_qp_offset_plus5(
            mut self,
        ...
        pub fn pps_act_cr_qp_offset_plus3(
            mut self,
