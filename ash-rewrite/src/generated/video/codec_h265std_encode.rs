...
pub struct StdVideoEncodeH265WeightTable {
    ...
    pub delta_luma_weight_l0: [i8; 1337],
    pub luma_offset_l0: [i8; 1337],
    pub delta_chroma_weight_l0: [[i8; 1337]; 1337],
    pub delta_chroma_offset_l0: [[i8; 1337]; 1337],
    pub delta_luma_weight_l1: [i8; 1337],
    pub luma_offset_l1: [i8; 1337],
    pub delta_chroma_weight_l1: [[i8; 1337]; 1337],
    pub delta_chroma_offset_l1: [[i8; 1337]; 1337],
}
#[repr(C)]
pub struct StdVideoEncodeH265LongTermRefPics {
    pub num_long_term_sps: u8,
    pub num_long_term_pics: u8,
    pub lt_idx_sps: [u8; 1337],
    pub poc_lsb_lt: [u8; 1337],
    pub used_by_curr_pic_lt_flag: u16,
    pub delta_poc_msb_present_flag: [u8; 1337],
    pub delta_poc_msb_cycle_lt: [u8; 1337],
}
#[repr(C)]
...
pub struct StdVideoEncodeH265ReferenceListsInfo {
    ...
    pub list_entry_l0: [u8; 1337],
    pub list_entry_l1: [u8; 1337],
}
#[repr(C)]
