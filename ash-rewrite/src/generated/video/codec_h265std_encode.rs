...
pub(crate) mod reexport {
    ...
    impl EncodeH265LongTermRefPics {
        ...
        pub fn used_by_curr_pic_lt_flag(
            mut self,
...
- `slice_loop_filter_across_slices_enabled_flag` @ `11..12`*/
    ...
    impl EncodeH265SliceSegmentHeaderFlags {
        ...
        pub fn dependent_slice_segment_flag(
            ...
            self.bitfield0 = ((dependent_slice_segment_flag << 1u32) & 0x00000002)
                | rest;
            self
        }
        ...
        pub fn deblocking_filter_override_flag(
            ...
            self.bitfield0 = ((deblocking_filter_override_flag << 8u32) & 0x00000100)
                | rest;
            self
        }
        ...
        pub fn slice_deblocking_filter_disabled_flag(
            ...
            self.bitfield0 = ((slice_deblocking_filter_disabled_flag << 9u32)
                & 0x00000200) | rest;
            self
        }
    ...
    impl<'a> EncodeH265SliceSegmentHeader<'a> {
        pub fn flags(
            mut self,
            flags: crate::vk::EncodeH265SliceSegmentHeaderFlags,
        ) -> Self {
            self.flags = flags;
            self
        }
...
- `ref_pic_list_modification_flag_l1` @ `1..2`*/
    ...
    impl EncodeH265ReferenceListsInfo {
        pub fn flags(
            mut self,
            flags: crate::vk::EncodeH265ReferenceListsInfoFlags,
        ) -> Self {
            self.flags = flags;
            self
        }
...
- `slice_temporal_mvp_enabled_flag` @ `8..9`*/
        ...
        fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
            f.debug_struct("StdVideoEncodeH265PictureInfoFlags")
                ...
                .field(
                    ...
                    &self.get_slice_temporal_mvp_enabled_flag(),
                )
                .finish()
        }
    }
    impl EncodeH265PictureInfoFlags {
        ...
        pub fn used_for_long_term_reference(
            ...
            let rest = self.bitfield0 & 0xFFFFFFFB;
            self.bitfield0 = ((used_for_long_term_reference << 2u32) & 0x00000004)
                | rest;
            self
        }
        ...
        pub fn no_output_of_prior_pics_flag(
            ...
            let rest = self.bitfield0 & 0xFFFFFFBF;
            self.bitfield0 = ((no_output_of_prior_pics_flag << 6u32) & 0x00000040)
                | rest;
            self
        }
        ...
        pub fn short_term_ref_pic_set_sps_flag(
            ...
            let rest = self.bitfield0 & 0xFFFFFF7F;
            self.bitfield0 = ((short_term_ref_pic_set_sps_flag << 7u32) & 0x00000080)
                | rest;
            self
        }
        ...
        pub fn slice_temporal_mvp_enabled_flag(
            ...
            let rest = self.bitfield0 & 0xFFFFFEFF;
            self.bitfield0 = ((slice_temporal_mvp_enabled_flag << 8u32) & 0x00000100)
                | rest;
            self
        }
    ...
    impl<'a> EncodeH265PictureInfo<'a> {
        ...
        pub fn short_term_ref_pic_set_idx(
            mut self,
