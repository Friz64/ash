...
pub struct StdVideoEncodeH265WeightTable {
    ...
    pub delta_luma_weight_l0: [i8; crate::vk::STD_VIDEO_H265_MAX_NUM_LIST_REF],
    pub luma_offset_l0: [i8; crate::vk::STD_VIDEO_H265_MAX_NUM_LIST_REF],
    pub delta_chroma_weight_l0: [[i8; crate::vk::STD_VIDEO_H265_MAX_CHROMA_PLANES]; crate::vk::STD_VIDEO_H265_MAX_NUM_LIST_REF],
    pub delta_chroma_offset_l0: [[i8; crate::vk::STD_VIDEO_H265_MAX_CHROMA_PLANES]; crate::vk::STD_VIDEO_H265_MAX_NUM_LIST_REF],
    pub delta_luma_weight_l1: [i8; crate::vk::STD_VIDEO_H265_MAX_NUM_LIST_REF],
    pub luma_offset_l1: [i8; crate::vk::STD_VIDEO_H265_MAX_NUM_LIST_REF],
    pub delta_chroma_weight_l1: [[i8; crate::vk::STD_VIDEO_H265_MAX_CHROMA_PLANES]; crate::vk::STD_VIDEO_H265_MAX_NUM_LIST_REF],
    pub delta_chroma_offset_l1: [[i8; crate::vk::STD_VIDEO_H265_MAX_CHROMA_PLANES]; crate::vk::STD_VIDEO_H265_MAX_NUM_LIST_REF],
}
#[repr(C)]
pub struct StdVideoEncodeH265LongTermRefPics {
    pub num_long_term_sps: u8,
    pub num_long_term_pics: u8,
    pub lt_idx_sps: [u8; crate::vk::STD_VIDEO_H265_MAX_LONG_TERM_REF_PICS_SPS],
    pub poc_lsb_lt: [u8; crate::vk::STD_VIDEO_H265_MAX_LONG_TERM_PICS],
    pub used_by_curr_pic_lt_flag: u16,
    pub delta_poc_msb_present_flag: [u8; crate::vk::STD_VIDEO_H265_MAX_DELTA_POC],
    pub delta_poc_msb_cycle_lt: [u8; crate::vk::STD_VIDEO_H265_MAX_DELTA_POC],
}
#[repr(C)]
...
pub struct StdVideoEncodeH265ReferenceListsInfo {
    ...
    pub ref_pic_list0: [u8; crate::vk::STD_VIDEO_H265_MAX_NUM_LIST_REF],
    pub ref_pic_list1: [u8; crate::vk::STD_VIDEO_H265_MAX_NUM_LIST_REF],
    pub list_entry_l0: [u8; crate::vk::STD_VIDEO_H265_MAX_NUM_LIST_REF],
    pub list_entry_l1: [u8; crate::vk::STD_VIDEO_H265_MAX_NUM_LIST_REF],
}
#[repr(C)]
...
pub const STD_VULKAN_VIDEO_CODEC_H265_ENCODE_SPEC_VERSION: usize = 69;
pub const STD_VULKAN_VIDEO_CODEC_H265_ENCODE_EXTENSION_NAME: &'static core::ffi::CStr = c"VK_STD_vulkan_video_codec_h265_encode";
