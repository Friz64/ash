...
- `UsePrevFrameMvs` @ `7..8`*/
    ...
    impl DecodeVP9PictureInfoFlags {
        ...
        pub fn frame_parallel_decoding_mode(
            ...
            self.bitfield0 = ((frame_parallel_decoding_mode << 4u32) & 0x00000010)
                | rest;
            self
        }
    ...
    impl<'a> DecodeVP9PictureInfo<'a> {
        ...
        pub fn color_config(
            mut self,
            color_config: &'a crate::vk::VP9ColorConfig,
        ) -> Self {
        ...
        pub fn segmentation(
            mut self,
            segmentation: &'a crate::vk::VP9Segmentation,
        ) -> Self {
