...
pub(crate) mod items {
    ...
    impl<'a> QueueFamilyGlobalPriorityProperties<'a> {
        ...
        pub fn priorities_as_slice(&self) -> &'_ [crate::vk::QueueGlobalPriority] {
    ...
    impl core::fmt::Debug for MemoryUnmapFlags {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            crate::debug_flags(f, &[(Self::RESERVE_EXT.0, "RESERVE_EXT")], self.0)
        }
    }
    ...
    impl MemoryUnmapFlagBits {
        ...
        pub const fn bitmask(&self) -> MemoryUnmapFlags {
            MemoryUnmapFlags::from_raw(self.0)
        }
    }
    #[cfg(feature = "debug")]
        ...
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            crate::debug_flags(
                ...
                &[
                    ...
                    (
                        Self::RAY_TRACING_ALLOW_SPHERES_AND_LINEAR_SWEPT_SPHERES_NV.0,
                    ...
                    (
                        Self::DISALLOW_OPACITY_MICROMAP_ARM.0,
                        "DISALLOW_OPACITY_MICROMAP_ARM",
                    ),
                    (Self::INSTRUMENT_SHADERS_ARM.0, "INSTRUMENT_SHADERS_ARM"),
                    (Self::CAPTURE_DATA_KHR.0, "CAPTURE_DATA_KHR"),
                    ...
                    (
                        Self::OPACITY_MICROMAP_DISALLOW_MIXED_SPECIAL_INDEX_KHR.0,
    ...
    impl PipelineCreateFlagBits2 {
        ///Converts this enum variant to the corresponding bitmask
        pub const fn bitmask(&self) -> PipelineCreateFlags2 {
            PipelineCreateFlags2::from_raw(self.0)
        }
    }
    #[cfg(feature = "debug")]
        ...
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            crate::debug_flags(
                ...
                &[
                    ...
                    (Self::PREPROCESS_BUFFER_EXT.0, "PREPROCESS_BUFFER_EXT"),
                ],
                self.0,
            )
        }
    ...
    impl BufferUsageFlagBits2 {
        ///Converts this enum variant to the corresponding bitmask
        pub const fn bitmask(&self) -> BufferUsageFlags2 {
            BufferUsageFlags2::from_raw(self.0)
        }
    }
    #[cfg(feature = "debug")]
    ...
    impl core::fmt::Debug for HostImageCopyFlags {
        fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
            crate::debug_flags(f, &[(Self::MEMCPY.0, "MEMCPY")], self.0)
        }
    }
    impl HostImageCopyFlags {
        pub const fn empty() -> Self {
    ...
    impl HostImageCopyFlagBits {
        ///Converts this enum variant to the corresponding bitmask
        pub const fn bitmask(&self) -> HostImageCopyFlags {
            HostImageCopyFlags::from_raw(self.0)
        }
    }
    #[cfg(feature = "debug")]
